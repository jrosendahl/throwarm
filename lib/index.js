...
function enableDebug(){
	console.log('-----------------------------------------------------------');
	console.log('------------------Throwarm Debug Enabled-------------------');
	console.log('-----------------------------------------------------------');
	debug = true;
}
...
function Datagram(self) {
	function fill (query) {
		function keyRepresentsSingleValue(item, index) {
			var isSame;
			...
			if(debug && !isSame) {
				console.log('key: ' + key);
				console.log('Row 0:' +query[0][self.fieldMap[key]]);
				console.log('Row ' + index + ': ' + item[self.fieldMap[key]]);
			}
			return isSame;
		}
